...
from dentalmapcert.coverage import coverage_from_point_cloud, synthetic_coverage
...
.analyze_view_quality` is called for views that lack explicit quality tags,
    ...
    if image_paths_per_view:
        from dentalmapcert.image_quality import analyze_view_quality  # lazy import
